			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="facebookUser-label" class="property-label"><g:message code="user.facebookUser.label" default="Facebook User" /></span>
						...
						<span class="property-value" aria-labelledby="facebookUser-label"><g:link controller="facebookUser" action="show" id="${userInstance?.facebookUser?.id}">${userInstance?.facebookUser?.encodeAsHTML()}</g:link></span>
